...
trips.each do |row|
  ...
  Trip.create!(duration: row[:duration], start_date: start_date, start_station_name: row[:start_station_name], end_date: end_date, end_station_name: row[:end_station_name], bike_id: row[:bike_id], subscription_type: row[:subscription_type], zip_code: row[:zip_code])
